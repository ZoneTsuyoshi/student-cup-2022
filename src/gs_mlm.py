...
def gs_main(config):
    ...
    model_list = ["roberta-base", "xlnet-base-cased", "microsoft/deberta-v3-base", "microsoft/deberta-base",
                 "roberta-large", "xlnet-large-cased", "microsoft/deberta-v3-large", "microsoft/deberta-large"]
    bs_list = np.repeat(np.array([8,4]), 4).tolist()
